...
## Friction Between Developers and Operations
...
- Versioning: You need some software to manage different versions of source code (the raw materials for IT industry). So if some problem arises in some version (or tags), you can know exactly which version of the code is causing problem, and you can easily revert back to earlier changes.
-


# Four Key Metrics of software development and delivery
...
The challenge of an ML process is to create a bridge between code and data in a controlled way.
